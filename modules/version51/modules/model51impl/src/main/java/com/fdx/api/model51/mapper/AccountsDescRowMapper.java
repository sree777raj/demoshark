...
import com.fdx.api.model51.modelimpl.AccountCategory;
import org.springframework.jdbc.core.RowMapper;

import com.fdx.api.model51.modelimpl.AccountDescriptor;
import com.fdx.api.model51.modelimpl.AccountType;
...
public class AccountsDescRowMapper implements RowMapper<AccountDescriptor> {
	...
	public AccountDescriptor mapRow(ResultSet rs, int arg1) throws SQLException {
		...
		if (rs.getString("accountCategory") != null)
			account.setAccountCategory(AccountCategory.valueOf(rs.getString("accountCategory")));
