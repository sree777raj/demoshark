...
import com.fdx.api.model51.mapper.InsuranceAccountsRowMapper;
...
public class InsuranceAccount {
	...
	@Override
	public String toString() {
		return "InsuranceAccount [accountId=" + accountId + ", account=" + account
				+ ", policyPremium=" + policyPremium + ", policyPremiumTerm=" + policyPremiumTerm
