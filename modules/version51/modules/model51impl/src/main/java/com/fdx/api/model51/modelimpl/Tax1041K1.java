...
import com.fdx.api.model51.mapper.Tax1041K1StatementRowMapper;
 ...
 */
@ApiModel(description = "Beneficiary's Share of Income, Deductions, Credits, etc.")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2021-05-31T16:14:56.890768600+05:30[Asia/Calcutta]")
public class Tax1041K1 {
	...
	public String toString() {
		return "Tax1041K1 [tax=" + tax + ", finalK1=" + finalK1 + ", amendedK1=" + amendedK1 + ", fiscalYearBegin="
	...
	private static final Logger log = LoggerFactory.getLogger(Tax1041K1.class);

	public Tax1041K1 getTax1041K1(int internalId) throws FDXException {
		try {
			template = ConnectionConfigApi51.getTemplate();
			SqlParameterSource parameters = new MapSqlParameterSource("internalId", internalId);
			Tax1041K1 tax1041K1;
			try {
				tax1041K1 = template.queryForObject(
						"select * from "+ DeveloperContext.getDeveloperSchema() +".tax1041K1 where internalId in (:internalId)", parameters,
						new Tax1041K1StatementRowMapper());
			} catch (EmptyResultDataAccessException e) {
				throw new FDXException("Tax1041K1 not found", 0);
			}
//			OtherInfo Start
			List<CodeAmount> otherInfoListResponse = new ArrayList<>();
			if (tax1041K1.getOtherInfo() != null) {
				List<CodeAmount> otherInfoList = tax1041K1.getOtherInfo();
				...
				tax1041K1.setOtherInfo(otherInfoListResponse);
			}
//			OtherInfo End

//			Credits Start
			List<CodeAmount> creditsListResponse = new ArrayList<>();
			if (tax1041K1.getCredits() != null) {
				List<CodeAmount> creditsList = tax1041K1.getCredits();
				...
				tax1041K1.setCredits(creditsListResponse);
			}
//			Credits End

//			AmtAdjustments Start
			List<CodeAmount> amtAdjustmentsListResponse = new ArrayList<>();
			if (tax1041K1.getAmtAdjustments() != null) {
				List<CodeAmount> amtAdjustmentsList = tax1041K1.getAmtAdjustments();
				...
				tax1041K1.setAmtAdjustments(amtAdjustmentsListResponse);
			}
//			AmtAdjustments End

//			FinalYearDeductions Start
			List<CodeAmount> finalYearDeductionsListResponse = new ArrayList<>();
			if (tax1041K1.getFinalYearDeductions() != null) {
				List<CodeAmount> finalYearDeductionsList = tax1041K1.getFinalYearDeductions();
				...
				tax1041K1.setFinalYearDeductions(finalYearDeductionsListResponse);
			}
//			FinalYearDeductions End

//			FinalYearDeductions Start
			List<CodeAmount> directlyApportionedDeductionsListResponse = new ArrayList<>();
			if (tax1041K1.getDirectlyApportionedDeductions() != null) {
				List<CodeAmount> directlyApportionedDeductionsList = tax1041K1.getDirectlyApportionedDeductions();
				...
				tax1041K1.setDirectlyApportionedDeductions(directlyApportionedDeductionsListResponse);
			}
//			FinalYearDeductions End

//			BeneficiaryNameAddress Start
			NameAddress nameAddress = new NameAddress();
			if (tax1041K1.getBeneficiaryNameAddress() != null) {
				nameAddress = nameAddress
						.getNameAddressDetails(tax1041K1.getBeneficiaryNameAddress().getNameAddressId());
				tax1041K1.setBeneficiaryNameAddress(nameAddress);
			}
//			BeneficiaryNameAddress End

//			fiduciaryNameAddress Start
			NameAddress nameAddressFiduciary = new NameAddress();
			if (tax1041K1.getFiduciaryNameAddress() != null) {
				nameAddressFiduciary = nameAddressFiduciary
						.getNameAddressDetails(tax1041K1.getFiduciaryNameAddress().getNameAddressId());
				tax1041K1.setFiduciaryNameAddress(nameAddressFiduciary);
			}
