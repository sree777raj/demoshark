...
import com.fdx.api.model51.modelimpl.DebitCreditMemo;
...
import com.fdx.api.model51.modelimpl.InvestmentTransactionType;
...
import com.fdx.api.model51.modelimpl.Payee;
...
import com.fdx.api.model51.modelimpl.TransactionReason;
import com.fdx.api.model51.modelimpl.TransactionStatus;
import com.fdx.api.model51.modelimpl.Transactions;
import com.fdx.api.model51.modelimpl.Transfer;
...
public class MoneyMovementProcess {
	...
	public Payment51 processPayments(Payment51 payment) throws FDXException {
		...
		try {
			...
			return (Payment51) payment.getPaymentById(payment.getPaymentId());
	...
	public void validatetRecurringPaymentInput(RecurringPaymentForUpdate51 recurringPaymentForUpdate, Boolean isPost) throws FDXException {
		if (isPost) {
	...
	public void validatetPaymentInput(PaymentForUpdate51 paymentForUpdate, Boolean isPost) throws FDXException {
		if (isPost) {
	...
	public TransferStatus51 processTransfer(Transfer transfer) throws FDXException {
		...
		try {
			...
			return (TransferStatus51) transferStatusRepository.getTransferStatusDetails(transfer.getTransferId());
		} catch (FDXException fdxException) {
	...
	public TransferStatus51 postTransfer(Object transferInput) throws FDXException {
		Transfer transferRepository = new Transfer();
		ObjectMapper mapper = FdxUtil.getObjectMapper();
		Transfer transfer = mapper.convertValue(transferInput, new TypeReference<>() {
		});
