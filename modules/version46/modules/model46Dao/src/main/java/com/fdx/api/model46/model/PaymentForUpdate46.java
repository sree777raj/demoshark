...
@Repository
public interface PaymentForUpdate46<T> {

	<T> TypeReference getTypeRef();
	T postPaymentForUpdate(PaymentForUpdate46 paymentForUpdateInput, String recurringPaymentId) throws FDXException;
	String getPaymentId();
	...
	void updatePayment(String paymentId, PaymentForUpdate46 paymentForUpdate) throws FDXException;
}
