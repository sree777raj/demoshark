...
import com.fdx.api.model46.mapper.RecurringPaymentRowMapper;
...
@Repository("RecurringPayment46")
public class RecurringPayment implements RecurringPayment46<RecurringPayment> {
