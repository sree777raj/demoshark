...
import com.fdx.api.model46.mapper.RecurringPaymentForUpdateRowMapper;
...
public class RecurringPaymentForUpdate implements RecurringPaymentForUpdate46<RecurringPayment> {
...
/*	public RecurringPaymentForUpdate dueDate(Date dueDate) {
	...
	public RecurringPayment updateRecurringPayment(String recurringPaymentId, RecurringPaymentForUpdate46 recurringPaymentForUpdateIn)
			throws FDXException {
		int count = 0;
		try {
	...
	@Override
	public RecurringPayment postRecurringPayment(RecurringPaymentForUpdate46 recurringPaymentForUpdateIn)
