...
import com.fdx.api.model46.mapper.BillsRowMapper;
...
public class Bills {
	...
	@JsonFormat(shape = JsonFormat.Shape.STRING, lenient = OptBoolean.FALSE)
	private java.sql.Timestamp autoPayDate;
	...
	public java.sql.Timestamp getAutoPayDate() {
		return autoPayDate;
	}

	public void setAutoPayDate(java.sql.Timestamp autoPayDate) {
		this.autoPayDate = autoPayDate;
	}
