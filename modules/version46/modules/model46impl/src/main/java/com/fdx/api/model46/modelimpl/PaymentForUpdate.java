...
import com.fdx.api.model46.mapper.PaymentForUpdateRowMapper;
...
@Repository("PaymentForUpdate46")
public class PaymentForUpdate implements PaymentForUpdate46<Payment> {
  ...
  @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd", lenient = OptBoolean.FALSE)
	...
	@JsonIgnore
	public void updatePayment(String paymentId, PaymentForUpdate46 paymentForUpdateIn) throws FDXException {
	...
	@Override
	public Payment postPaymentForUpdate(PaymentForUpdate46 paymentForUpdate, String recurringPaymentId) throws FDXException {
		try {
