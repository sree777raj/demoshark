...
import com.fdx.api.model46.mapper.CustomerRowMapper;
...
@Repository("Customer46")
public class Customer implements Customer46<Customer> {
	...
	public Customer dateOfBirth(java.sql.Timestamp dateOfBirth) {
