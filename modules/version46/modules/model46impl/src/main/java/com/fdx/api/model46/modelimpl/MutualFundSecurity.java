...
import com.fdx.api.model46.mapper.MutualFundTypeRowMapper;
...
public class MutualFundSecurity {
	...
	private java.sql.Timestamp yieldAsOfDate;
	...
	public java.sql.Timestamp getYieldAsOfDate() {
		return yieldAsOfDate;
	}

	public void setYieldAsOfDate(java.sql.Timestamp yieldAsOfDate) {
		this.yieldAsOfDate = yieldAsOfDate;
	}
