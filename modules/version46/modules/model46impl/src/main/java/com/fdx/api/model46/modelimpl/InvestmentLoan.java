...
import com.fdx.api.model46.mapper.InvestmentLoanRowMapper;
...
public class InvestmentLoan {
	...
	private java.sql.Timestamp loanStartDate;
	...
	@JsonFormat(shape = JsonFormat.Shape.STRING, lenient = OptBoolean.FALSE)
	private java.sql.Timestamp loanMaturityDate;
	...
	@JsonFormat(shape = JsonFormat.Shape.STRING, lenient = OptBoolean.FALSE)
	private java.sql.Timestamp loanNextPaymentDate;
	...
	public java.sql.Timestamp getLoanStartDate() {
		return loanStartDate;
	}

	public void setLoanStartDate(java.sql.Timestamp loanStartDate) {
		this.loanStartDate = loanStartDate;
	}
	...
	public java.sql.Timestamp getLoanMaturityDate() {
		return loanMaturityDate;
	}

	public void setLoanMaturityDate(java.sql.Timestamp loanMaturityDate) {
		this.loanMaturityDate = loanMaturityDate;
	}
	...
	public java.sql.Timestamp getLoanNextPaymentDate() {
		return loanNextPaymentDate;
	}

	public void setLoanNextPaymentDate(java.sql.Timestamp loanNextPaymentDate) {
		this.loanNextPaymentDate = loanNextPaymentDate;
	}
