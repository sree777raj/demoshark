...
@Repository("Transfer46")
public class Transfer implements Transfer46<TransferStatus> {
	...
	@Override
	public TransferStatus postTransfer(Transfer46 transferIn) throws FDXException {
