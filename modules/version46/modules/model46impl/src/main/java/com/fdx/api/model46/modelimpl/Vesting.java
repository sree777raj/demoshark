...
import com.fdx.api.model46.mapper.VestingDateRowMapper;
...
public class Vesting {
	...
	private java.sql.Timestamp vestingDate;
	...
	public java.sql.Timestamp getVestingDate() {
		return vestingDate;
	}

	public void setVestingDate(java.sql.Timestamp vestingDate) {
		this.vestingDate = vestingDate;
	}
